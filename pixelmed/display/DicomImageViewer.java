...
public class DicomImageViewer extends ApplicationFrame implements 
	...
	{
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/display/DicomImageViewer.java,v 1.247 2020/01/01 15:48:14 dclunie Exp $";
	...
	private class DatabaseImportFromFilesActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent event) {
			cursorChanger.setWaitCursor();
			try {
				slf4jlogger.debug("DatabaseImportFromFilesActionListener.actionPerformed(): caling importer.choosePathAndImportDicomFiles()");
...
//System.err.print(TransferMonitor.report());
		...
		
		{
			...
			displayListOfPossibleReferenceImagesForTiledImages.addListSelectionListener(new OurReferenceListSelectionListener(referenceImagePanelForImages,false));
		}
